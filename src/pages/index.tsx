...
import vpPhoto from "@src/assets/leadership/shraddha-arbooj.png";
import principalPhoto from "@src/assets/leadership/shraddha-arbooj.png";

export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "The Millennial School — State Board & NEP Aligned School in Nashik" },
      {
        name: "description",
        content:
          "State Board, NEP-aligned day school in Nashik for children from Playgroup to Grade 10. Strong academics, caring teachers and a safe, modern campus. Admissions open.",
      },
    ],
  }),
  component: HomePage,
